...
function attachButtonListeners() {
    // Capcom ID is always confirmed at connect-streetfighter.html before
    ...
    // join itself once the ID is confirmed (see connect-streetfighter.js's
...
function loadMatches() {
    apiFetch("/api/matches?game=" + encodeURIComponent("Street Fighter 6"))
        .then(function (data) {
            if (!data.success) {
                matchesContainer.innerHTML = `
                    <div class="empty-state">
