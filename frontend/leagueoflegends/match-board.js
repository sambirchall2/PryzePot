...
function attachButtonListeners() {
    // Riot ID is always confirmed at connect-lol.html before
    ...
    // join itself once the ID is confirmed (see connect-lol.js's
...
function loadMatches() {
    apiFetch("/api/matches?game=" + encodeURIComponent("League of Legends"))
        .then(function (data) {
            if (!data.success) {
                matchesContainer.innerHTML = `
                    <div class="empty-state">
